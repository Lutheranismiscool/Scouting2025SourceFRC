...
function  transition(i) {
    if (i == 0 && state == "init") {
        ...
        let teamPos = document.getElementById("initPositionForm").value;
        ...
        if (!testing) {
            ...
            if (!["r1", "r2", "r3", "b1", "b2", "b3"].includes(teamPos)) {
                alert("Enter your team position correctly.");
            return;
            }
        }

        allianceColor = teamPos.charAt(0);
        console.log("Test1:"+allianceColor)
        console.log("Test2:"+teamPos)
        teamPos = teamPos.charAt(1);
        console.log("Test3:"+allianceColor)
        console.log("Test4:"+teamPos)
